...
const char * menuItems[MENU_COUNT] = {"Ganti Password", "WIFI Scan",  "RunText", "Relay", "RFID", "EvilTwin Mode", "Exit"};
long password = 1234;
  ...
  if (IrReceiver.decode()) {
    ...
    if (IrReceiver.decodedIRData.command == 22) {
      ...
      if (menuItems[menuIndex] == "Exit") {
        ...
        Relay();
      }else if (menuItems[menuIndex] == "RunText") {
        Serial.println("RunTextMode");
        lcd.clear();
        lcd.setCursor(0, 0);
